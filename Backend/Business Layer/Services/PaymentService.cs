...
namespace Business_Layer.Services
{
    ...
    {
        public async Task<Session> CreatePaymentSessionAsync(PaymentRequest request,string email)
        {
            var options = new SessionCreateOptions
            {
                ...
                SuccessUrl = $"http://localhost:4200/account/dashboard/{request.BookingType}",  
