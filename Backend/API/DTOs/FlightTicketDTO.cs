...
namespace API.DTOs
{
    public class FlightTicketDTO
    {
        ...
        // Methods
        public static FlightTicketDTO MapToFlightTicketDTO(Flight flight, double price, string seatClass)
        {
            FlightTicketDTO flightTicketDTO = new FlightTicketDTO()
            {
                ...
                AvailableSeats = flight.Airplane.Seats.Where(s=>s.IsAvailable).Count()
            };
